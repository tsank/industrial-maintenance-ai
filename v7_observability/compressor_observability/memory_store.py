...
Unchanged from v6 except:
  - Import updated from compressor_longtermrag to compressor_observability
...
Functions:
  write_episode()            — inserts one completed episode into memory_episodes
  search_similar_episodes()  — returns top-k similar past episodes via pgvector
